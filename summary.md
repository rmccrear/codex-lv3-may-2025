...
## Example 1: <pre><code class="..."> unescaped HTML

<details>
<summary>Show Me: HTML Button (pre+code with class, unescaped)</summary>
...
**Configuration:** `<pre><code class="language-html">` with unescaped HTML
...
**HTML `<pre>` tags (Examples 1-10):**
1. `<pre><code class="...">` unescaped HTML
...
**Markdown triple backticks (Examples 11-14):**
